...
import { Container, Content, Button, Icon, Text, H3, H2, Header, Left, Right, Card, CardItem, Thumbnail, Body } from 'native-base';
          ...
          <ImageBackground
            ...
            <Content padder>
              ...
              <H2 style={{ color: '#ff5500' }}>
                Home screen!! Home screen!!Home screen!!Home screen!!Home screen!!Home screen!!Home screen!!Home
                screen!! Home screen!!Home screen!!Home screen!!Home screen!!Home screen!!
              </H2>
              <Card >
                <CardItem>
                  <Left>
